...
public final class TestLexer {
    ...
    private static String ugly(ArrayList<Token> tokens) {
    ...
    public static final TestHarness.TestCase[] cases = {
        ...
        new Matches() {
            ...
            public String userCode() throws CompilerError {
                return ugly(new Lexer("abc def").lex());
            };
        },
        new Matches() {
            ...
            public String userCode() throws CompilerError {
                return ugly(new Lexer("1,;-123").lex());
            };
        },
        new Matches() {
        ...
        new Matches() {
            ...
            public String userCode() throws CompilerError {
                return ugly(new Lexer("& &x a&x").lex());
            };
        },
        new Matches() {
